 ...
 *
 */
public class NavActivity extends RelativeLayout implements View.OnClickListener {

    public NavActivity(Context context){
        this(context, null);
    }
    ...
    public NavActivity(Context context, AttributeSet attrs) {
        super(context, attrs);
        View view = LayoutInflater.from(context).inflate(R.layout.nav_activity, this, true);
