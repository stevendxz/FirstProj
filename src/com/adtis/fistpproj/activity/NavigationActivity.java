...
public class NavigationActivity extends LinearLayout {
    ...
    public NavigationActivity(Context context, AttributeSet attrs) {
        super(context,attrs);
...
//        setBackgroundResource(R.drawable.navigation_bg);
        setBackgroundColor(Color.parseColor("#16c6ff"));
...
//            btn_left.setBackgroundResource(R.drawable.backbg);// 设置背景
        ...
        if (null != strBtnLeft) {
            ...
            btnLeftParams.setMargins(50, 0, 0, 0);
            btn_left.setLayoutParams(btnLeftParams);
            btn_left.setText(strBtnLeft);
            btn_left.setVisibility(View.VISIBLE);
        } else {
            btn_left.setLayoutParams(new LayoutParams(100, 100));
        }
...
//            setBackgroundColor(Color.CYAN);
        ...
        if (null != strBtnRight) {
            ...
            LayoutParams btnRightParams = new LayoutParams(
                    LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT);
            btnRightParams.setMargins(0, 0, 50, 0);
            btn_right.setLayoutParams(btnRightParams);

            btn_right.setText(strBtnRight);
            btn_right.setVisibility(View.VISIBLE);
        } else {
            btn_right.setLayoutParams(new LayoutParams(100, 100));
        }
